...
//////////////////////////////////////////////////////////////////////////////////////
// load arp parameters from the buffer array
//////////////////////////////////////////////////////////////////////////////////////
void ArpLoad(void)
{
  ...
  {
    if ((ArpParameters[k] < (pgm_read_byte_near (&Default_ArpParameters[k][1]))) || (ArpParameters[k] > (pgm_read_byte_near (&Default_ArpParameters[k][2]))))
      ArpParameters[k] = pgm_read_byte_near (&Default_ArpParameters[k][0]);
    else
      ArpParameters[k]  = ArpParameters[k]; // leave unchanged (useful line for later, like random or smtg)
  }

  Init_aChord();

  // load indiv var with value array
  ui_external_clk = ArpParameters[0];
  bpm = ArpParameters[1];
  arp_send_notes = ArpParameters[2];
  ui_aGroove = ArpParameters[3];
  ui_aHold = ArpParameters[4];
  ui_SetAB = ArpParameters[5];
  ui_aSplit = ArpParameters[6];
  ui_TrspA = ArpParameters[7];
  ui_TrspB = ArpParameters[8];
  seqNbr = ArpParameters[9];
  ui_aMotif = ArpParameters[10];
  arp_div_index = ArpParameters[11];
  ui_aMltp = ArpParameters[12];
  ui_aGate = ArpParameters[13];
  ui_aOctave = ArpParameters[14];
  //clk_src = ArpParameters[15]; // not implemnted yet
  router_arp_tag = ArpParameters[16];
  ui_seqPlay = ArpParameters[17];
  seqSpeed = ArpParameters[18];
  seqLength = ArpParameters[19];
}

//////////////////////////////////////////////////////////////////////////////////////
// store arp parameters into the buffer array
//////////////////////////////////////////////////////////////////////////////////////
void ArpStore(void)
{
  ArpParameters[0] = ui_external_clk ;
  ArpParameters[1] = bpm ;
  ArpParameters[2] = arp_send_notes;
  ArpParameters[3] = ui_aGroove ;
  ArpParameters[4] = ui_aHold ;
  ArpParameters[5] = ui_SetAB ;
  ArpParameters[6] = ui_aSplit ;
  ArpParameters[7] = ui_TrspA ;
  ArpParameters[8] = ui_TrspB ;
  ArpParameters[9] = seqNbr ;
  ArpParameters[10] = ui_aMotif ;
  ArpParameters[11] = arp_div_index ;
  ArpParameters[12] = ui_aMltp ;
  ArpParameters[13] = ui_aGate ;
  ArpParameters[14] = ui_aOctave ;
  ArpParameters[15] = 0;// Clock source // not implemnted yet
  ArpParameters[16] = router_arp_tag ;
  ArpParameters[17] = ui_seqPlay ;
  ArpParameters[18] = seqSpeed ;
  ArpParameters[19] = seqLength ;
...
//////////////////////////////////////////////////////////////////////////////////////
// Init the ARP parameters and its array with default values
//////////////////////////////////////////////////////////////////////////////////////
void ArpInit(void)
{
  // copy default array
  ...
  ui_aGate = ArpParameters[13];
  ui_aOctave = ArpParameters[14];
  // triggerCV = ArpParameters[15]; // not implemnted yet
  router_arp_tag = ArpParameters[16];
  ui_seqPlay = ArpParameters[17];
  seqSpeed = ArpParameters[18];
  seqLength = ArpParameters[19];
