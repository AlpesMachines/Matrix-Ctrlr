...
const char DinDescription1 [] PROGMEM = " F1             ";  // 1
const char DinDescription2 [] PROGMEM = " DCO2 WAVEFORM  ";
const char DinDescription3 [] PROGMEM = " DCO2 CLIC      ";
const char DinDescription4 [] PROGMEM = " PATCH SELECT   ";
const char DinDescription5 [] PROGMEM = " EDIT           ";
const char DinDescription6 [] PROGMEM = " ARP            ";
const char DinDescription7 [] PROGMEM = " _SHIFT_        ";
const char DinDescription8 [] PROGMEM = " FILTER         "; // 8
const char DinDescription9 [] PROGMEM = " OSCILLATORS    ";
const char DinDescription10 [] PROGMEM = " _INC           ";
const char DinDescription11 [] PROGMEM = " _DEC           ";
const char DinDescription12 [] PROGMEM = " ENVELOPES      ";
const char DinDescription13 [] PROGMEM = " KEYBOARD       ";
const char DinDescription14 [] PROGMEM = " MATRIX MODULATE";
const char DinDescription15 [] PROGMEM = " PAGE           ";
const char DinDescription16 [] PROGMEM = " UNUSED DIN16   "; // 16
const char DinDescription17 [] PROGMEM = " ALT            ";
const char DinDescription18 [] PROGMEM = " CFG            ";
const char DinDescription19 [] PROGMEM = " F2             ";
...
const char DinDescription28 [] PROGMEM = " _MATRIX_A      "; 
const char DinDescription29 [] PROGMEM = " _MATRIX_B      ";
const char DinDescription30 [] PROGMEM = " _MATRIX_C      ";
const char DinDescription31 [] PROGMEM = " _MATRIX_D      ";
...
void UpdateDinStates(void)
{
  ...
  // pulse
  DOUT_PinSet(DOUT_DCO1_PULSE, (EditBuffer[EB_OSC1_WAVEFORM] & (1 << BIT0)) != 0);
  DOUT_PinSet(DOUT_DCO2_PULSE, (EditBuffer[EB_OSC2_WAVEFORM] & (1 << BIT0)) != 0);

  // wave
  DOUT_PinSet(DOUT_DCO1_WAVE, (EditBuffer[EB_OSC1_WAVEFORM] & (1 << BIT1)) != 0);
  DOUT_PinSet(DOUT_DCO2_WAVE, (EditBuffer[EB_OSC2_WAVEFORM] & (1 << BIT1)) != 0);

  // click
  DOUT_PinSet(DOUT_DCO1_CLICK, (EditBuffer[EB_OSC1_CLICK] & (1 << BIT0)) != 0);
  DOUT_PinSet(DOUT_DCO2_CLICK, (EditBuffer[EB_OSC2_CLICK] & (1 << BIT0)) != 0);

  // noise bit?
  if ((EditBuffer[EB_OSC2_WAVEFORM] & (1 << BIT2)) != 0)
    Osc2_ClickMode = 2;
  else
    Osc2_ClickMode = 0;

  // sync mode
  if (EditBuffer[EB_OSC_SYNCMODE] > 0)
