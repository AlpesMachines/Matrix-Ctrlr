...
// LCD display defines ---------
#define firmware "0.99x"
#define  LCD_ROWS  2
#define  LCD_COLS  20
//LiquidCrystal lcd(2, 3, 6, 4, 7, 5); // julien proto arduino debut
LiquidCrystal lcd(44, 45, 40, 43, 41, 42); // julien proto arduino (ne marche pas en 47/48) ... pour les 2 premieres entrées A4 A5 ok
//LiquidCrystalFast lcd(44, 45, 40, 43, 41, 42); // julien proto arduino (ne marche pas en 47/48) ... pour les 2 premieres entrées A4 A5 ok
boolean appflag_updateDisplay;

// used to debug various stuff
#define DEBUG_looptime 0
#define DEBUG_analog   1
#define DEBUG_din      1
#define DEBUG_dout     1
#define DEBUG_serialout 1
#define DEBUG_LCDparamvaluedescription 1
#define DEBUG_softpanel 1
#define DEBUG_eeprom 1
#define DEBUG_inteeprom 1
#define DEBUG_encoder 1
#define DEBUG_device 1
#define DEBUG_midi 1
#define DEBUG_router 1
#define DEBUG_sysexhandler 1
#define DEBUG_sysexbankhandler 1
#define DEBUG_bargraph 1
...
#define DEBUG_ARP2 1
#define DEBUG_ARPN 1
#define DEBUG_ARP2STEP 1
#define DEBUG_ARP2CHORD 0
#define DEBUG_ARPSTACK 1
#define DEBUG_TRIG 1
...
boolean RefreshSoftPanel = 0;
boolean encoder_inverted = 1;
...
// VARIABLES
////////////////////////////////////////////////////////////////////////////////////////////
//int potQuality = 1022; // define the relatie quality of potentiometer (1020 to 1024)
//byte AnalogMuxDelay = 1; // delay introduced in the loop while muxing analog (microsec). not useful anymore with nopx3
...
// triggers (CV gate inputs)
  ...
  // initialise comportement de l'encodeur (CCW or CW increments)
  encoder_inverted = EEPROM.read(EEPROM_ENCODER_INVERTED);
