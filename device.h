...
#define Matrix_Device_A 0x0a // matrix connected to Serial1 
#define Matrix_Device_B 0x0b // matrix connected to Serial2
#define Matrix_Device_C 0x0c // matrix connected to Serial4
#define Matrix_Device_D 0x0d // matrix connected to Serial5
/*
...
extern unsigned char matrix_modele; // indicate if matrix6 or 1000
...
extern void ChooseEditBufferABCD(unsigned char device, bool process);
